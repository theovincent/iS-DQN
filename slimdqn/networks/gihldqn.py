...
class GIHLDQN:
    ...
    def loss(
        ...
        # This term is - CrossEntropy(projected_target, stop_gradient(projected_target))
        log_probs = jnp.log(jnp.maximum(projected_target, 1e-5))
        entropy = -jnp.sum(projected_target * jax.lax.stop_gradient(log_probs))
        return (
