...
MMDQN_ARGS="--experiment_name L2_MM_${SHARED_NAME}_${GAME}"
...
MMISDQN_ARGS="--experiment_name L2_MM_K${N_BELLMAN_ITERATIONS}_${SHARED_NAME}_${GAME} --n_bellman_iterations $N_BELLMAN_ITERATIONS"
