...
SHARED_NAME="LN${LAYER_NORM}_${ARCHITECTURE_TYPE}_T${TARGET_UPDATE_FREQ}_SOFT_ALPHA0_SOFTACT"
# ----- L2 Loss -----
...
# launch_job/atari/${PLATFORM}_metaisdqn.sh --first_seed 1 --last_seed 2 --n_parallel_seeds 2 $SHARED_ARGS $ISDQN_ARGS
# launch_job/atari/${PLATFORM}_metaisdqn.sh --first_seed 5 --last_seed 5 --n_parallel_seeds 1 $SHARED_ARGS $ISDQN_ARGS
