...
sbatch --job-name $EXPERIMENT_NAME-$ALGO_NAME --array=$FIRST_SEED-$LAST_SEED --cpus-per-task=1 --mem-per-cpu=3G --time=00:20:00 --gres=gpu:1 --prefer="rtx3090|a5000" --partition gpu \
